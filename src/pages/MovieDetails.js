...
export const MovieDetails = () => {
  ...
  const loadMovie = async () => {
    ...
    const res = await axios.get("https://yts.mx/api/v2/movie_details.json", {
      params: { movie_id: id ?? "", with_cast: true, with_images: true },
    });
  ...
  return (
    <>
      ...
      <div className="movie-details-page">
        <section
          style={{
            backgroundImage: `linear-gradient(rgba(60, 60, 60, 0.4), rgba(29, 29, 29, 1)), url(${movie.background_image_original})`,
          }}
        >
              ...
              <>
                <div className="image-box">
                  ...
                  <div className="button">
                    <a>
                      <button className="blue">Watch Now</button>
                    </a>
                  </div>
                </div>
              </>
                  ...
                  {movie.cast?.map((x, key) => (
                    <>
                      <div className="cast-member">
                        <div className="image">
                          <a
                            href={"https://www.imdb.com/name/nm" + x.imdb_code}
                            target="_blank"
                          >
                            <img src={x.url_small_image} />
                          </a>
                        </div>
      ...
      <DialogBox
        close={() => setIsDownloadVisible(false)}
        open={isDownloadVisible}
        styles={downloadBoxStyles}
      >
