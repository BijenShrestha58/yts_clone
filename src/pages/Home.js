...
export const Home=()=>
{
    ...
    const loadMovies=()=>{
        setLoading(true);
        axios.get("https://yts.mx/api/v2/list_movies.json",{params:{page:1,sort_by: 'download_count', order_by:'desc', limit: 4, with_rt_ratings: true}}).then(res=>{
        ...
        <>
            <section>
                <div className="text-area">
                    ...
                    <a>IMPORTANT - YTS.MX is the only new official domain for YIFY Movies</a>
                    <div className="links">
                        <img src={telegram}/><a>YTSMX_UPDATES </a>
                        <div className="line"></div>
                        <img src={twitter}/><a>Upcoming:</a>
                    </div>
                    <div className="title"><span className="material-icons">star</span>Popular Downloads</div>
                </div>
